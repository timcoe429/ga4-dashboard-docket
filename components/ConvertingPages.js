import { TrendingUp, TrendingDown, Target, Users, Eye, ChevronDown, ChevronUp } from 'lucide-react';
                    ...
                    {showComparison && page.trend !== undefined && (
                      <div className={`flex items-center gap-1 text-xs ${
                        ...
                        <div className="text-center">
                          ...
                          {page.sessionsTrend !== undefined && (
                            <div className={`${page.sessionsTrend > 0 ? 'text-green-600' : page.sessionsTrend < 0 ? 'text-red-600' : 'text-gray-500'}`}>
                              {page.sessionsTrend > 0 ? '+' : ''}{page.sessionsTrend}% Sessions
                            </div>
                          )}
                          {page.conversionsTrend !== undefined && (
                            <div className={`${page.conversionsTrend > 0 ? 'text-green-600' : page.conversionsTrend < 0 ? 'text-red-600' : 'text-gray-500'}`}>
                              {page.conversionsTrend > 0 ? '+' : ''}{page.conversionsTrend}% Conv.
                            </div>
                          )}
                        </div>
                      </div>
