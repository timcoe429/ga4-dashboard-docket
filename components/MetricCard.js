    ...
    <div className={`bg-white rounded-xl shadow-sm border-2 p-6 transition-all ${
      ...
      <div className="flex items-center gap-1 mb-2">
        ...
        <div className="relative group">
          ...
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10 max-w-xs text-center">
